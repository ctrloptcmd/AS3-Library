package com.ctrloptcmd.twitter {	
		...
		*/
		...
		import flash.events.IOErrorEvent;import com.ctrloptcmd.utils.XTrace;
			...
			import com.ctrloptcmd.utils.XTrace;
		
		import com.ctrloptcmd.string.URLValidator;

	public class TwitterListPipe extends EventDispatcher {
		...
		public function TwitterListPipe (_userID : String, _listName: String, _ignoreReplies : Boolean = true) {
				...
				request = new URLRequest("http://pipes.yahooapis.com/pipes/pipe.run?_id=72924f968a12e0146b101718fe5438a0&_render=rss&listname=creuna-ria-team&username=ctrloptcmd");
			...
			if (loader.data) {
				...
				txml = new XML(loader.data);
					for each (var xTweet:XML in txml..item) {
						...
						var tweet : Object = {};
							tweet.author = xTweet..author.text();
							tweet.raw = sTweet;
